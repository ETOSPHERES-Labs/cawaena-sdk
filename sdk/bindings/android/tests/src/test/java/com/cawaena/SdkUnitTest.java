...
import com.cawaena.model.CaseDetailsResponse;
import com.cawaena.model.CaseIdResponse;
import com.cawaena.model.NewViviswapUser;
import com.cawaena.model.TransactionStatusResponse;
import com.cawaena.model.TxDetailsResponse;
import com.cawaena.model.ViviswapKycStatus;
import com.cawaena.model.ViviswapPartiallyKycDetails;
...
public class SdkUnitTest {
    ...
    @Test
    public void BshouldInitializeUser() throws Exception {
    ...
    public void EshouldGenerateReceiverAddress() throws Exception {
        ...
        wireMockRule.stubFor(put(urlPathEqualTo("/api/user/address"))
                ...
                .withHeader("X-APP-USERNAME", equalTo(USERNAME))
                .withHeader("X-APP-NAME", equalTo(AUTH_PROVIDER))
                .withQueryParam("payment_method", equalTo("IOTA"))
    ...
    public void ShouldCreatePurchaseRequest() throws Exception {
        ...
        final String reqBody = "{" + System.lineSeparator()
                ...
                + String.format("\"currency\":\"%s\",", CURRENCY) + System.lineSeparator()
